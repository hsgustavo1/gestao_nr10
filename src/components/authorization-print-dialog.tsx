      ...
      <DialogContent className="sm:max-w-lg print:shadow-none">
        ...
        <div id="print-content" className="space-y-4 text-sm">
          <div className="text-center border-b pb-4">
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Atvos — Gestão NR-10</p>
            <h2 className="text-lg font-bold mt-1">AUTORIZAÇÃO DE TRABALHO</h2>
            <p className="text-xs text-muted-foreground">NR-10 — Segurança em Instalações e Serviços em Eletricidade</p>
          </div>

          <div className="grid grid-cols-2 gap-3 text-xs">
            <div>
              <p className="font-semibold text-muted-foreground uppercase text-[10px]">Colaborador</p>
            ...
            <div className="col-span-2">
              <p className="font-semibold text-muted-foreground uppercase text-[10px]">Abrangência</p>
              <p>{authorization.abrangencia ?? "—"}</p>
            </div>
            <div>
              <p className="font-semibold text-muted-foreground uppercase text-[10px]">Data da Autorização</p>
            ...
            <div>
              ...
              <p className={authorization.valid ? "text-emerald-600 font-semibold" : "text-destructive font-semibold"}>
