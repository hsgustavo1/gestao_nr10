...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RAC - Bloqueio de energias perigosas" },
      { property: "og:description", content: "Bloqueio de energias perigosas: controle de dispositivos, auditoria e monitoramento de bloqueios." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "RAC - Bloqueio de energias perigosas" },
      { name: "twitter:description", content: "Bloqueio de energias perigosas: controle de dispositivos, auditoria e monitoramento de bloqueios." },
